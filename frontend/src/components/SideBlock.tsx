...
import { usePositions, useWatchlist, useSelectedStock, useStocks, useMarket } from '../store/hooks';
      ...
      <div>
        ...
        <div>
          {watchlistItems.map(item => {
            const matchingQuote = quotes.find(q => q.symbol === item.stock.symbol);
            const currentPrice = matchingQuote?.current_price ?? '—';
